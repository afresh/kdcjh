...
using EWeb.Sessions;
using EWeb.Web.Controllers.Results;
using EWeb.Web.Models;
using EWeb.Web.Models.Account;
...
{
    public class AccountController : EWebControllerBase
    {
        ...
        public ActionResult Login(string returnUrl = "/Account/Index/")
        {
        ...
        [HttpPost]
        [DisableAuditing]
        public async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "/Account/Index/", string returnUrlHash = "")
        {
            CheckModelState();
